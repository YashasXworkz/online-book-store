          ...
          <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
                  ...
                  <div class="input-group">
                    <input type="text" name="book" class="form-control bg-light border-0 small"
              ...
              <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Welcome to Online Book Store</h1>
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <h5 class="text-gray-900 mb-4">Welcome to the Online Book Store!</h5>
                      <p class="text-gray-600 mb-4">Explore our vast collection of books and find your next great read.
                      </p>
                      <a href="${pageContext.request.contextPath}/books" class="btn btn-success btn-icon-split">
                        <span class="icon text-white-50">
                          <i class="fas fa-book"></i>
                        </span>
                        <span class="text">Browse Books</span>
                      </a>
                    </div>
                  </div>
                </div>
