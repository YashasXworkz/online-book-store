                ...
                <div class="card mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                      <i class="fas fa-book-medical"></i> Book Information
                    </h6>
                  </div>
                  <div class="card-body">
                    <form:form method="POST" action="${pageContext.request.contextPath}/admin/books/add"
                      modelAttribute="book">
                      <div class="row">
                        <div class="col-md-6">
                      ...
                      <div class="form-group text-center">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/books" class="btn btn-secondary ml-3">
